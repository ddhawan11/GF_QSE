...
var_form           = produce_variational_form(mol_data,operators,ansatz={'type':'q_uccsd','reps':3})
...
var_form           = produce_variational_form(mol_data,operators,ansatz={'type':'efficient_su2','reps':3,'entanglement':'linear'})
results            = run_vqe(mol_data,operators,var_form,optimizer_dict={'name':'bfgs','max_iter':1000},
...
var_form           = produce_variational_form(mol_data,operators,ansatz={'type':'fabric','entanglement':'full','reps':3})
results            = run_vqe(mol_data,operators,var_form,optimizer_dict={'name':'bfgs','max_iter':1000},
