...
results            = run_vqe(mol_data,operators,var_form,optimizer_dict={'name':'bfgs','max_iter':1000},
                             instance_dict={'instance':'statevector_simulator','shots':1},fname_prefix='vqe_so4',outfile=outfile,
                             measure_1rdm=True)

var_form           = produce_variational_form(mol_data,operators,ansatz={'type':'fabric','entanglement':'full','reps':1})
results            = run_vqe(mol_data,operators,var_form,optimizer_dict={'name':'bfgs','max_iter':1000},
                             instance_dict={'instance':'statevector_simulator','shots':1},fname_prefix='fabric',outfile=outfile,
                             measure_1rdm=True)
