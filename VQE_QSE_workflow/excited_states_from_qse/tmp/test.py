...
operator_pool = build_qse_operators(excitations='ip',dressed=False,mol_info=core)
...
d_list = build_qse_operators(excitations='ip',dressed=False,mol_info=core)[:x['molecule_info']['n']]
